...
BEGIN
    ...
    WITH taxonomy(department, name) AS (
        ...
        FROM (VALUES
            ...
            ('rental_accommodation', 'Rent & Accommodation', 'Room rent'),
            ('rental_accommodation', 'Rent & Accommodation', 'Apartment rent'),
            ('rental_accommodation', 'Rent & Accommodation', 'Short stay'),
            ('rental_accommodation', 'Utilities', 'Electricity'),
            ('rental_accommodation', 'Utilities', 'Water'),
            ('rental_accommodation', 'Utilities', 'Internet'),
            ('rental_accommodation', 'Utilities', 'Waste collection'),
            ('rental_accommodation', 'Deposits & Fees', 'Security deposit'),
            ('rental_accommodation', 'Deposits & Fees', 'Booking fee'),
            ('rental_accommodation', 'Deposits & Fees', 'Late payment fee'),
            ('rental_accommodation', 'Maintenance', 'Repairs'),
            ('rental_accommodation', 'Maintenance', 'Cleaning'),
            ('rental_accommodation', 'Maintenance', 'Laundry'),
            ('rental_accommodation', 'Services', 'Parking'),
            ('rental_accommodation', 'Services', 'Extra guest fee'),
